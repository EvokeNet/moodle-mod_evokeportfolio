...
define([
    ...
    function($, Config, Str, ModalFactory, ModalEvents, Fragment, Ajax, Swal, Y) {
         ...
         * @private
         */
        CreateChapter.prototype.course = -1;
         ...
         * @method init
         */
        CreateChapter.prototype.init = function(selector) {
            var triggers = $(selector);

            return Str.get_string('createchapter', 'mod_evokeportfolio').then(function(title) {
                // Create the modal.
        ...
        CreateChapter.prototype.handleFormSubmissionResponse = function(data) {
            ...
            var tableLine = $('<tr>' +
                ...
                '<a href="#" data-id="'+item.id+'" data-name="'+item.name+'" data-dependentchapters="'+item.dependentchapters+'"' +
                'class="btn btn-warning btn-sm edit-evokeportfolio-chapter">' +
                '<i class="fa fa-pencil-square-o text-white"></i>' +
                '</a> ' +
                '<a href="#" data-id="'+item.id+'" class="btn btn-danger btn-sm delete-evokeportfolio-chapter">' +
            ...
            tableLine
                .appendTo('.table-evokeportfolio-chapters tbody')
                .hide().fadeIn('normal');
        ...
        CreateChapter.prototype.submitFormAjax = function(e) {
            ...
            // Now we can continue...
            Ajax.call([{
                methodname: 'mod_evokeportfolio_createchapter',
        ...
        return {
            init: function(selector, contextid, course) {
                return new CreateChapter(selector, contextid, course);
            }
        };
    }
);
