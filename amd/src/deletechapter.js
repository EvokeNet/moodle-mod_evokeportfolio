...
define(['jquery', 'core/ajax', 'core/str', 'mod_evokeportfolio/sweetalert'], function($, Ajax, Str, Swal) {
    ...
    DeleteChapter.prototype.getStrings = function() {
    ...
    DeleteChapter.prototype.registerEventListeners = function() {
        $("body").on("click", ".delete-evokeportfolio-chapter", function(event) {
    ...
    DeleteChapter.prototype.deleteItemRow = function(eventTarget) {
        var request = Ajax.call([{
            methodname: 'mod_evokeportfolio_deletechapter',
            args: {
                chapter: {
    ...
    DeleteChapter.prototype.removeChapterLine = function(eventTarget) {
    ...
    DeleteChapter.prototype.showToast = function(type, message) {
