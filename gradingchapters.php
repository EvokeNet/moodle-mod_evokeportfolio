...
/**
 * Grading chapters of mod_evokeportfolio.
 *
...
$PAGE->set_url('/mod/evokeportfolio/gradingchapters.php', ['id' => $id]);
...
$contentrenderable = new \mod_evokeportfolio\output\gradingchapters($course, $context);
