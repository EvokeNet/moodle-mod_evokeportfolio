...
$submission = $DB->get_record('evokeportfolio_submissions', ['id' => $id], '*', MUST_EXIST);

list ($course, $cm) = get_course_and_cm_from_instance($submission->portfolioid, 'evokeportfolio');

$context = context_module::instance($cm->id);

if (!has_capability('mod/evokeportfolio:edit', $context) || $USER->id != $submission->userid) {
